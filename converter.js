//converts to nepali no format

function exportsNepaliNo(strNum) {
    var nums = {
            0: '०',
            1: '१',
            2: '२',
  ...
  function offsetBSDays(dayData) {
    ...
    var npDayOfWeek = dayOfWeek,
      enDayOfWeek = (dayOfWeek, {'lang': 'en'});
  
    var totalDays = calendar_data[bs_date.year][bs_date.month - 1]
    var dateObj = {
      ne:{
        year: exportsNepaliNo(bs_date.year),
        month: exportsNepaliNo(bs_date.month),
        day: exportsNepaliNo(bs_date.day),
